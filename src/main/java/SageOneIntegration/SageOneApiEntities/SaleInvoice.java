...
public final class SaleInvoice extends MainEntity {
    ...
    private SageOneDatabaseEntityRelationship[] carriage_tax_code;
    private double carriage_tax_rate_percentage;
    ...
    public final String getInvoice_number() {
        return (this.isInitialized()) ? this.invoice_number : "";
    }

    public final void setInvoice_number(final String invoice_number) {
        this.invoice_number = (this.isInitialized()) ? invoice_number : this.invoice_number;
    }
    ...
    public final double getCarriage_tax_rate_percentage() {
        return (this.isInitialized()) ? this.carriage_tax_rate_percentage : -0.01;
    }

    public final void setCarriage_tax_rate_percentage(final double carriage_tax_rate_percentage) {
        this.carriage_tax_rate_percentage = (this.isInitialized()) ? carriage_tax_rate_percentage : this.carriage_tax_rate_percentage;
    }

    public final SageOneDatabaseEntityRelationship[] getCarriage_tax_code() {
        return (this.isInitialized()) ? this.carriage_tax_code : new SageOneDatabaseEntityRelationship[0];
    }

    public final void setCarriage_tax_code(final SageOneDatabaseEntityRelationship[] carriage_tax_code) {
        this.carriage_tax_code = (this.isInitialized()) ? carriage_tax_code : this.carriage_tax_code;
    }

    public final double getCarriage() {
        return (this.isInitialized()) ? this.carriage : -0.01;
    }

    public final void setCarriage(final double carriage) {
        this.carriage = (this.isInitialized()) ? carriage : this.carriage;
    }
