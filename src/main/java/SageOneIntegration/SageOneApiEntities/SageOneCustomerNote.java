 ...
 */
public final class SageOneCustomerNote extends SageOneMainEntity {
    ...
    public SageOneCustomerNote() {

    }

    public final Integer getCustomerId() {
        return (this.isInitialized()) ? this.CustomerId: null;
    }

    public final void setCustomerId(final Integer CustomerId) {
        this.CustomerId = (this.isInitialized()) ? CustomerId : this.CustomerId;
    }

    public final String getCustomerName() {
        return (this.isInitialized()) ? this.CustomerName : null;
    }

    public final void setCustomerName(final String CustomerName) {
        this.CustomerName = (this.isInitialized()) ? CustomerName : this.CustomerName;
    }

    public final Integer get() {
        return (this.isInitialized()) ? this.NotePriority : null;
    }

    public final void setNotePriority(final Integer NotePriority) {
        this.NotePriority = (this.isInitialized()) ? NotePriority : this.NotePriority;
    }

    public final Integer getNoteType() {
        return (this.isInitialized()) ? this.NoteType : null;
    }

    public final void setNoteType(final Integer NoteType) {
        this.NoteType = (this.isInitialized()) ? NoteType : this.NoteType;
    }
